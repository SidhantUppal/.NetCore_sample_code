...
namespace CFMData
{
    public partial class GLAccountList
    {
        ...
        private GLAccountList DataPortal_Fetch(GLAccountCriteria criteria)
        {
            bool cancel = false;
            ...
            using (var connection = new SqlConnection(ADOHelper.ConnectionString))
            {
                ...
                command.Parameters.AddWithValue("@p_UpdatedOnHasValue", criteria.UpdatedOnHasValue);
                    using(var reader = command.ExecuteReader())
                    {
                        ...
                        if(reader.Read())
                        {
                           var rowParser = reader.GetRowParser<CFMData.GLAccount>();
                           do
                           {
								
                              this.Add(CFMData.GLAccount.GetGLAccount(rowParser, reader));
                           }while(reader.Read());
                        }
						OnFetched();
                        return this;
