...
namespace CFMData
{
    public partial class GLEntityList
    {
        
        private GLEntityList DataPortal_Fetch(GLEntityCriteria criteria)
        {
            bool cancel = false;
            ...
            using (var connection = new SqlConnection(ADOHelper.ConnectionString))
            {
                ...
                command.Parameters.AddWithValue("@p_UpdatedOnHasValue", criteria.UpdatedOnHasValue);
                    using(var reader = command.ExecuteReader())
                    {
                        ...
                        if(reader.Read())
                        {
                           var rowParser = reader.GetRowParser<CFMData.GLEntity>();
                           do
                           {
								
                              this.Add(CFMData.GLEntity.GetGLEntity(rowParser, reader));
                           }while(reader.Read());
                        }
						OnFetched();
                        return this;
