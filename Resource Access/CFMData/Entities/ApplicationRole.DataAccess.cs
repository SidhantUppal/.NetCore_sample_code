...
namespace CFMData
{
	public partial class ApplicationRole
	{
		...
		private ApplicationRole DataPortal_Fetch(ApplicationRoleCriteria criteria)
		{
			...
			{
				connection.Open();
				using (var command = new SqlCommand("[dbo].[spCFM_ApplicationRole_Select]", connection))
				{
                ...
                command.Parameters.AddWithValue("@p_UpdatedOnHasValue", criteria.UpdatedOnHasValue);
					using(var reader = command.ExecuteReader())
					{
						...
						if(reader.Read())
						{
							return GetApplicationRole(rowParser, reader);							
						}                            
						else
							throw new Exception(String.Format("The record was not found in 'dbo.ApplicationRole' using the following criteria: {0}.", criteria));
					}
				}
			}
			OnFetched();
       ...
       // [Transactional(TransactionalTypes.TransactionScope)]
		...
		protected   void UpdateChildren(ApplicationRole parent,SqlConnection connection,SqlTransaction trans)
		{
		...
		protected   void DataPortal_DeleteSelf()
		{
			...
			if (cancel) return;            
			DataPortal_Delete(new ApplicationRoleCriteria (ApplicationRoleID));        
			OnSelfDeleted();
		}
        
		//[Transactional(TransactionalTypes.TransactionScope)]
		protected void DataPortal_Delete(ApplicationRoleCriteria criteria)
		{
            bool cancel = false;
            ...
            {
                connection.Open();
                using (var command = new SqlCommand("[dbo].[spCFM_ApplicationRole_Delete]", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        ///    CSLA editable child business object of type <see cref="ApplicationRole"/> 
        /// </summary>
        /// <returns></returns>
        ...
        public void Child_Insert(SystemRole systemRole, SqlConnection connection,SqlTransaction trans)
        {
            Child_Insert(null, systemRole, connection,trans);
        }
        ...
        private void Child_DeleteSelf(SqlConnection connection)
        {
            ...
            //DataPortal_Delete(new ApplicationRoleCriteria (ApplicationRoleID), connection);
		...
		public void InitDTO()
		{
			  ApplicationRoleDTO dt=new ApplicationRoleDTO();
			dt.ApplicationRoleID =this.ApplicationRoleID ;
			dt.Name =this.Name ;
			dt.SystemRoleID =this.SystemRoleID ;
			dt.IsSystemRole =this.IsSystemRole ;
  ...
  this.CurrentDTO = dt;
        ...
        private void Map(SafeDataReader reader)
        {
            ...
            using(BypassPropertyChecks)
            {
                ...
                LoadProperty(_isSystemRoleProperty, reader["IsSystemRole"]);
