...
namespace CFMData
{
	public partial class HomeClient
	{
		...
		private HomeClient DataPortal_Fetch(HomeClientCriteria criteria)
		{
			...
			using (var connection = new SqlConnection(ADOHelper.ConnectionString))
			{
                ...
                command.Parameters.AddWithValue("@p_UpdatedOnHasValue", criteria.UpdatedOnHasValue);
					...
					{
						var rowParser = reader.GetRowParser<HomeClient>();                       
						if(reader.Read())
						{
							return GetHomeClient(rowParser, reader);							
						}                            
						else
							throw new Exception(String.Format("The record was not found in 'dbo.HomeClient' using the following criteria: {0}.", criteria));
					}
				}
			}
			OnFetched();
       ...
       // [Transactional(TransactionalTypes.TransactionScope)]
		...
		protected   void DataPortal_DeleteSelf()
		{
			...
			if (cancel) return;            
			DataPortal_Delete(new HomeClientCriteria (HomeClientID));        
			OnSelfDeleted();
		}
        
		//[Transactional(TransactionalTypes.TransactionScope)]
		protected void DataPortal_Delete(HomeClientCriteria criteria)
		{
            bool cancel = false;
            ...
            {
                connection.Open();
                using (var command = new SqlCommand("[dbo].[spCFM_HomeClient_Delete]", connection))
                {
                    command.CommandType = CommandType.StoredProcedure;
        ...
        ///    CSLA editable child business object of type <see cref="HomeClient"/> 
        /// </summary>
        /// <returns></returns>
        ...
        {
            Child_Insert(null, client, null, connection,trans);
        }
        ...
        {
            Child_Update(null, client, null, connection,trans);
        }
        ...
        private void Child_DeleteSelf(SqlConnection connection)
        {
            ...
            //DataPortal_Delete(new HomeClientCriteria (HomeClientID), connection);
		...
		public void InitDTO()
		{
			  HomeClientDTO dt=new HomeClientDTO();
			dt.HomeClientID =this.HomeClientID ;
			dt.HomeID =this.HomeID ;
			dt.ClientID =this.ClientID ;
			dt.EntryDate =this.EntryDate ;
			dt.ExitDate =this.ExitDate ;
  ...
  this.CurrentDTO = dt;
        ...
        private void Map(SafeDataReader reader)
        {
            ...
            using(BypassPropertyChecks)
            {
                ...
                LoadProperty(_entryDateProperty, reader["EntryDate"]);
                LoadProperty(_exitDateProperty, reader["ExitDate"]);
