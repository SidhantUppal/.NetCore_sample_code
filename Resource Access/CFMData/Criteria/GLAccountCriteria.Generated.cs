...
{
    [Serializable]
    public partial class GLAccountCriteria 
    {
        private readonly Dictionary<string, object> _bag = new Dictionary<string, object>();
        
        #region Constructors

        public GLAccountCriteria(){}

        public GLAccountCriteria(System.Int32 gLAccountID)
        {
        ...
        {
            get { return GetValue<System.String>("AccountCode"); }
            set { _bag["AccountCode"] = value; }
        }

        public System.String AccountName
        {
            get { return GetValue<System.String>("AccountName"); }
