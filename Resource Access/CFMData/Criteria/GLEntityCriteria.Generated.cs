...
{
    [Serializable]
    public partial class GLEntityCriteria 
    {
        private readonly Dictionary<string, object> _bag = new Dictionary<string, object>();
        
        #region Constructors

        public GLEntityCriteria(){}

        public GLEntityCriteria(System.Int32 gLEntityID)
        {
        ...
        {
            get { return GetValue<System.Int32>("EntityTypeID"); }
            set { _bag["EntityTypeID"] = value; }
        }
