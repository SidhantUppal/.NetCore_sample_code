...
{
    [Serializable]
    public partial class SystemRoleTypeCriteria 
    {
        private readonly Dictionary<string, object> _bag = new Dictionary<string, object>();
        
        #region Constructors

        public SystemRoleTypeCriteria(){}

        public SystemRoleTypeCriteria(System.Int32 systemRoleTypeID)
        {
